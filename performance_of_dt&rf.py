...
if __name__ == '__main__':
    ...
    print(classification_report(y_predict,y_test,target_names=fonts))
    rf=RandomForestClassifier(n_estimators=256,oob_score=True,max_features=md,min_impurity_decrease=mid)
